# ============================================================
#  Jaswant Portfolio - Push to GitHub (Local Wins)
...
$REPO_PATH  = 'D:\Projects\Websites\Jaswant'
$BRANCH     = 'main'
$REMOTE_URL = 'https://github.com/jass666/jaswant-kanojia'
$REPO_NAME  = 'Jaswant Portfolio'
